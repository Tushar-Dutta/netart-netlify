import trophyLogo from "./assets/1.png";
import congratsLogo from "./assets/2.png";
import './companydetails.css';
export default function Companydetails(){
    return(
        <div className="detailsCompany">
          <img src={trophyLogo} className="trophyLogo"></img>
          <div>
            <h6>
            ...
            <img src={congratsLogo} className="companyLogo"></img>
            <br></br>
            <p>
